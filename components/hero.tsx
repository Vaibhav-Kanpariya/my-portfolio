        ...
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
              Hi, I&apos;m{" "}
              <span className="gradient-text">Vaibhav Kanpariya</span>
            </h1>
          ...
          <div className="max-w-[700px] text-muted-foreground">
            <p className="text-lg">
              Building scalable, secure, and efficient systems with over 2 years
              of experience
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 mt-6">
            ...
            >
              <a
                href="https://my-personal-info-bucket-0112.s3.ap-south-1.amazonaws.com/Vaibhav+Resume.pdf"
                target="_blank"
          ...
          <div className="flex gap-4 mt-6">
            ...
            <Button variant="ghost" size="icon" asChild>
              <Link href="mailto:kanpariyavaibhav966@gmail.com">
